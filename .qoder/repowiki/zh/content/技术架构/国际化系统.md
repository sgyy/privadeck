...
- [tools-developer.json](file://messages/de/tools-developer.json)
- [tools-developer.json](file://messages/fr/tools-developer.json)
- [tools-developer.json](file://messages/es/tools-developer.json)
- [tools-developer.json](file://messages/pt-BR/tools-developer.json)
- [tools-developer.json](file://messages/pt-PT/tools-developer.json)
- [tools-developer.json](file://messages/it/tools-developer.json)
- [tools-developer.json](file://messages/nl/tools-developer.json)
- [tools-developer.json](file://messages/pl/tools-developer.json)
- [tools-developer.json](file://messages/ru/tools-developer.json)
- [tools-developer.json](file://messages/tr/tools-developer.json)
- [tools-developer.json](file://messages/uk/tools-developer.json)
- [tools-developer.json](file://messages/vi/tools-developer.json)
- [tools-developer.json](file://messages/th/tools-developer.json)
- [tools-developer.json](file://messages/hi/tools-developer.json)
- [tools-developer.json](file://messages/id/tools-developer.json)
...
## 更新摘要
**变更内容**
- **重大更新**：国际化系统扩展了对JSON编辑器的完整多语言支持，现已覆盖33种语言
- **影响范围**：新增JSON编辑器工具的多语言翻译支持，涵盖所有现有语言环境
- **语言覆盖**：从原有的约22种语言扩展到33种语言的完整JSON编辑器本地化支持
...
**更新** 新增越南语（vi）完整本地化支持，现包含通用界面、音频工具、开发者工具、图像工具、PDF工具和视频工具的完整翻译内容（**视频工具翻译已移除**）。
- **新增阿拉伯语（ar）完整本地化支持**，现包含通用界面、音频工具、开发者工具、图像工具、PDF工具的完整翻译内容（**视频工具翻译已移除**）
- **新增乌克兰语（uk）完整本地化支持**，现包含通用界面、图像工具、PDF工具的完整翻译内容（**视频工具翻译已移除**）
- 越南语翻译文件现已覆盖所有主要功能区域，总计约83KB的翻译数据
- **阿拉伯语翻译文件现已移除视频工具相关翻译**，仅包含通用界面、音频工具、开发者工具、图像工具、PDF工具的翻译内容
- **乌克兰语翻译文件现已移除视频工具相关翻译**，仅包含通用界面、图像工具、PDF工具的翻译内容
