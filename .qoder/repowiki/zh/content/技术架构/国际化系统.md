...
## 更新摘要
**变更内容**
- **重大更新**：新增乌克兰语（uk）和阿拉伯语（ar）支持，完善RTL布局优化
...
D1 --> D3[tools-*.json]
D1 --> D4[ar/]
D4 --> D5[common.json - 514行]
D4 --> D6[tools-audio.json - 191行]
D4 --> D7[tools-developer.json - 962行]
D4 --> D8[tools-image.json - 1114行]
D4 --> D9[tools-pdf.json - 681行]
D4 --> D10[tools-video.json - 已移除]
D1 --> D11[en/]
...
D1 --> D18[uk/]
D18 --> D19[common.json - 514行]
D18 --> D20[tools-audio.json - 191行]
D18 --> D21[tools-developer.json - 962行]
D18 --> D22[tools-image.json - 1114行]
