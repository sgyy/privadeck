...
B1 --> B3[tools-*.json]
B1 --> B4[vi/]
B4 --> B5[common.json - 508行]
B4 --> B6[tools-audio.json - 191行]
B4 --> B7[tools-developer.json - 809行]
B4 --> B8[tools-image.json - 822行]
B4 --> B9[tools-pdf.json - 681行]
B4 --> B10[tools-video.json - 814行]
end
subgraph "组件层"
