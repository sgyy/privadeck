...
- [messages/de/tools-pdf.json](file://messages/de/tools-pdf.json)
- [messages/ja/tools-pdf.json](file://messages/ja/tools-pdf.json)
</cite>
...
该项目采用现代React技术栈，使用Next.js框架和TypeScript进行开发，支持多语言国际化。PDF预览功能通过两个主要组件协同工作：文件信息预览组件和页面渲染预览组件，为用户提供完整的PDF浏览体验。
...
PDF文件预览组件由两个主要部分组成，每个部分都有特定的功能和职责：
...
**章节来源**
- [PdfFilePreview.tsx:18-85](file://src/components/shared/PdfFilePreview.tsx#L18-L85)
...
PDF预览组件的依赖关系相对简单但功能完整，主要依赖于pdfjs-dist库和相关的工具函数。
